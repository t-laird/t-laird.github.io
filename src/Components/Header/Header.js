    ...
    <header>
      ...
      <nav>
        <ul>
          ...
          <li><a href="https://www.turing.io/sites/default/files/resumes/ThomasLaird.pdf" target="_blank" rel="noopener noreferrer">Resume<i className="icon-link-ext"></i></a></li>
        </ul>
      </nav>
    </header>
  );
